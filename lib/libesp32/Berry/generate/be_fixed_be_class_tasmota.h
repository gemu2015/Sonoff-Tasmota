...
static be_define_const_map_slots(be_class_tasmota_map) {
    { be_const_key(strptime, 53), be_const_func(l_strptime) },
    { be_const_key(delay_microseconds, -1), be_const_func(l_delay_microseconds) },
    { be_const_key(_fl, -1), be_const_var(0) },
    { be_const_key(publish_result, 66), be_const_func(l_publish_result) },
    ...
    { be_const_key(scale_uint, 44), be_const_func(l_scaleuint) },
    { be_const_key(get_switch, 23), be_const_func(l_getswitch) },
    { be_const_key(_debug_present, 47), be_const_var(2) },
    { be_const_key(gen_cb, 43), be_const_closure(Tasmota_gen_cb_closure) },
    { be_const_key(event, -1), be_const_closure(Tasmota_event_closure) },
    { be_const_key(get_option, -1), be_const_func(l_getoption) },
    { be_const_key(eth, 82), be_const_func(l_eth) },
    { be_const_key(time_dump, 58), be_const_func(l_time_dump) },
    { be_const_key(_find_op, -1), be_const_func(tasm_find_op) },
    { be_const_key(cmd_res, 12), be_const_var(3) },
    ...
    { be_const_key(add_driver, 10), be_const_closure(Tasmota_add_driver_closure) },
    ...
    { be_const_key(remove_rule, 13), be_const_closure(Tasmota_remove_rule_closure) },
    ...
    { be_const_key(_crons, 14), be_const_var(4) },
    { be_const_key(memory, 60), be_const_func(l_memory) },
    ...
    { be_const_key(resp_cmnd, 83), be_const_func(l_respCmnd) },
    { be_const_key(_settings_ptr, 90), be_const_comptr(&Settings) },
    ...
    { be_const_key(get_free_heap, 55), be_const_func(l_getFreeHeap) },
    { be_const_key(read_sensors, -1), be_const_func(l_read_sensors) },
    { be_const_key(wd, 78), be_const_var(6) },
    { be_const_key(exec_rules, -1), be_const_closure(Tasmota_exec_rules_closure) },
    { be_const_key(response_append, 45), be_const_func(l_respAppend) },
    { be_const_key(urlfetch_cmd, -1), be_const_closure(Tasmota_urlfetch_cmd_closure) },
    { be_const_key(run_cron, 41), be_const_closure(Tasmota_run_cron_closure) },
    ...
    { be_const_key(resp_cmnd_failed, 37), be_const_func(l_respCmndFailed) },
    { be_const_key(millis, 34), be_const_func(l_millis) },
    { be_const_key(wire_scan, -1), be_const_closure(Tasmota_wire_scan_closure) },
    { be_const_key(resp_cmnd_done, 6), be_const_func(l_respCmndDone) },
    { be_const_key(get_power, 56), be_const_func(l_getpower) },
    { be_const_key(web_send, -1), be_const_func(l_webSend) },
    { be_const_key(_ccmd, 68), be_const_var(8) },
    { be_const_key(strftime, 65), be_const_func(l_strftime) },
    { be_const_key(_rules, 84), be_const_var(9) },
    { be_const_key(settings, -1), be_const_var(10) },
    { be_const_key(add_cmd, 16), be_const_closure(Tasmota_add_cmd_closure) },
    { be_const_key(find_op, 57), be_const_closure(Tasmota_find_op_closure) },
    { be_const_key(log, 50), be_const_func(l_logInfo) },
    { be_const_key(cmd, 26), be_const_closure(Tasmota_cmd_closure) },
    { be_const_key(hs2rgb, 69), be_const_closure(Tasmota_hs2rgb_closure) },
    { be_const_key(_global_def, -1), be_const_comptr(&be_tasmota_global_struct) },
    { be_const_key(remove_fast_loop, 21), be_const_closure(Tasmota_remove_fast_loop_closure) },
    { be_const_key(remove_timer, 72), be_const_closure(Tasmota_remove_timer_closure) },
    ...
    { be_const_key(next_cron, 81), be_const_closure(Tasmota_next_cron_closure) },
    { be_const_key(remove_cron, -1), be_const_closure(Tasmota_remove_cron_closure) },
    { be_const_key(publish_rule, 29), be_const_func(l_publish_rule) },
    ...
    { be_const_key(urlfetch, 80), be_const_closure(Tasmota_urlfetch_closure) },
