...
static be_define_const_map_slots(m_libBLE_map) {
    ...
    { be_const_key(set_svc, 5), be_const_ctype_func(be_BLE_set_service) },
    { be_const_key(run, -1), be_const_ctype_func(be_BLE_run) },
    { be_const_key(serv_cb, 0), be_const_ctype_func(be_BLE_reg_server_cb) },
    { be_const_key(init, 7), be_const_func(be_BLE_init) },
    { be_const_key(store, -1), be_const_ctype_func(be_BLE_store) },
    ...
    { be_const_key(conn_cb, 8), be_const_ctype_func(be_BLE_reg_conn_cb) },
