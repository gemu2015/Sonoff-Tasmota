...
static be_define_const_map_slots(be_class_AudioOutputI2S_map) {
    ...
    { be_const_key_weak(INTERNAL_DAC, -1), be_const_int(AudioOutputI2S::INTERNAL_DAC) },
    { be_const_key_weak(set_lsb_justified, -1), be_const_ctype_func(i2s_output_i2s_set_lsb_justified) },
    { be_const_key_weak(stop, 1), be_const_func(i2s_output_i2s_stop) },
    { be_const_key_weak(INTERNAL_PDM, 2), be_const_int(AudioOutputI2S::INTERNAL_PDM) },
    { be_const_key_weak(deinit, 6), be_const_func(i2s_output_i2s_deinit) },
