...
static be_define_const_map_slots(be_class_Leds_frame_map) {
    ...
    { be_const_key_weak(setitem, -1), be_const_closure(Leds_frame_be_setitem_closure) },
    { be_const_key_weak(pixel_size, -1), be_const_var(0) },
    { be_const_key_weak(item, -1), be_const_closure(Leds_frame_be_item_closure) },
    { be_const_key_weak(blend_pixels, 2), be_const_func(be_leds_blend_pixels) },
    { be_const_key_weak(init, 0), be_const_closure(Leds_frame_be_init_closure) },
    { be_const_key_weak(blend, -1), be_const_static_func(be_leds_blend) },
    { be_const_key_weak(set_pixel, 1), be_const_closure(Leds_frame_be_set_pixel_closure) },
};
