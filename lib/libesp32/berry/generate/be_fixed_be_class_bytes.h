...
static be_define_const_map_slots(be_class_bytes_map) {
    ...
    { be_const_key(set, 9), be_const_func(m_set) },
    ...
    { be_const_key(size, 19), be_const_func(m_size) },
    { be_const_key(init, 1), be_const_func(m_init) },
    { be_const_key(fromb64, 37), be_const_func(m_fromb64) },
    { be_const_key(get, -1), be_const_func(m_getu) },
    { be_const_key(deinit, 28), be_const_func(m_deinit) },
    { be_const_key(append, 11), be_const_func(m_connect) },
    { be_const_key(seti, -1), be_const_func(m_set) },
    { be_const_key(setbytes, -1), be_const_func(m_setbytes) },
    { be_const_key(_X2Elen, 36), be_const_var(0) },
    { be_const_key(tostring, -1), be_const_func(m_tostring) },
    { be_const_key(_X2Esize, 24), be_const_var(1) },
    { be_const_key(_X2Ep, -1), be_const_var(2) },
    { be_const_key(clear, -1), be_const_func(m_clear) },
    { be_const_key(add, -1), be_const_func(m_add) },
    { be_const_key(tob64, 25), be_const_func(m_tob64) },
    ...
    { be_const_key(copy, 6), be_const_func(m_copy) },
    { be_const_key(reverse, 14), be_const_func(m_reverse) },
    { be_const_key(ismapped, -1), be_const_func(m_is_mapped) },
    { be_const_key(tohex, 5), be_const_func(m_tohex) },
    { be_const_key(setitem, 10), be_const_func(m_setitem) },
