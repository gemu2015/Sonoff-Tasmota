...
static be_define_const_map_slots(be_class_serial_map) {
    ...
    { be_const_key(SERIAL_8N2, 5), be_const_int(SERIAL_8N2) },
    ...
    { be_const_key(deinit, 32), be_const_func(b_serial_deinit) },
    { be_const_key(SERIAL_7E1, -1), be_const_int(SERIAL_7E1) },
    { be_const_key(SERIAL_5E2, 11), be_const_int(SERIAL_5E2) },
