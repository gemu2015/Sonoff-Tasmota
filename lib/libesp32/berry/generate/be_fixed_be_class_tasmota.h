...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(set_timer, 4), be_const_closure(class_Tasmota_set_timer_closure) },
    { be_const_key(delay, -1), be_const_func(l_delay) },
    { be_const_key(gen_cb, 47), be_const_closure(class_Tasmota_gen_cb_closure) },
    ...
    { be_const_key(_crons, 12), be_const_var(3) },
    ...
    { be_const_key(remove_cmd, 70), be_const_closure(class_Tasmota_remove_cmd_closure) },
    ...
    { be_const_key(cmd, 30), be_const_closure(class_Tasmota_cmd_closure) },
    ...
    { be_const_key(add_driver, 83), be_const_closure(class_Tasmota_add_driver_closure) },
    ...
    { be_const_key(find_list_i, 69), be_const_closure(class_Tasmota_find_list_i_closure) },
    ...
    { be_const_key(add_fast_loop, 57), be_const_closure(class_Tasmota_add_fast_loop_closure) },
    ...
    { be_const_key(run_cron, 75), be_const_closure(class_Tasmota_run_cron_closure) },
    ...
    { be_const_key(compile, 18), be_const_closure(class_Tasmota_compile_closure) },
    ...
    { be_const_key(next_cron, 26), be_const_closure(class_Tasmota_next_cron_closure) },
