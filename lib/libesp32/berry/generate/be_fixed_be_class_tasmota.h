...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(wire1, -1), be_const_var(1) },
    { be_const_key(time_dump, 64), be_const_func(l_time_dump) },
    { be_const_key(get_free_heap, -1), be_const_func(l_getFreeHeap) },
    { be_const_key(resp_cmnd_str, 42), be_const_func(l_respCmndStr) },
    ...
    { be_const_key(_crons, 12), be_const_var(4) },
    { be_const_key(_fl, -1), be_const_var(5) },
    ...
    { be_const_key(add_cron, 55), be_const_closure(Tasmota_add_cron_closure) },
    { be_const_key(hostname, 58), be_const_func(l_hostname) },
    { be_const_key(_rules, 91), be_const_var(6) },
    { be_const_key(rtc, 6), be_const_static_func(l_rtc) },
    { be_const_key(scale_int, -1), be_const_static_func(l_scaleint) },
    { be_const_key(_timers, 43), be_const_var(7) },
    { be_const_key(set_power, -1), be_const_func(l_setpower) },
    { be_const_key(wire2, -1), be_const_var(8) },
    { be_const_key(millis, 73), be_const_func(l_millis) },
    ...
    { be_const_key(remove_cmd, 70), be_const_closure(Tasmota_remove_cmd_closure) },
    { be_const_key(resp_cmnd_error, 92), be_const_func(l_respCmndError) },
    { be_const_key(publish, 34), be_const_func(be_mqtt_publish) },
    ...
    { be_const_key(memory, 41), be_const_static_func(l_memory) },
    { be_const_key(rtc_utc, -1), be_const_func(l_rtc_utc) },
    ...
    { be_const_key(add_driver, 83), be_const_closure(Tasmota_add_driver_closure) },
    { be_const_key(get_switch, -1), be_const_func(l_getswitch) },
    { be_const_key(i2c_enabled, 103), be_const_func(l_i2cenabled) },
    ...
    { be_const_key(get_power, 52), be_const_func(l_getpower) },
    { be_const_key(run_deferred, -1), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(find_list_i, 69), be_const_closure(Tasmota_find_list_i_closure) },
    { be_const_key(publish_result, 32), be_const_func(l_publish_result) },
    { be_const_key(resp_cmnd_done, -1), be_const_func(l_respCmndDone) },
    { be_const_key(scale_uint, 2), be_const_static_func(l_scaleuint) },
    { be_const_key(add_rule, -1), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(wifi, -1), be_const_static_func(l_wifi) },
    { be_const_key(exec_cmd, -1), be_const_closure(Tasmota_exec_cmd_closure) },
    { be_const_key(add_fast_loop, 57), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(response_append, -1), be_const_func(l_respAppend) },
    { be_const_key(eth, -1), be_const_static_func(l_eth) },
    { be_const_key(resolvecmnd, 31), be_const_func(l_resolveCmnd) },
    { be_const_key(_settings_ptr, 3), be_const_comptr(&Settings) },
    { be_const_key(locale, -1), be_const_func(l_locale) },
    { be_const_key(settings, 29), be_const_var(10) },
    { be_const_key(_global_def, -1), be_const_comptr(&be_tasmota_global_struct) },
    { be_const_key(arch, -1), be_const_func(l_arch) },
    { be_const_key(run_cron, 75), be_const_closure(Tasmota_run_cron_closure) },
    ...
    { be_const_key(compile, 18), be_const_closure(Tasmota_compile_closure) },
    ...
    { be_const_key(get_switches, 66), be_const_func(l_getswitch) },
    { be_const_key(next_cron, 26), be_const_closure(Tasmota_next_cron_closure) },
    ...
    { be_const_key(_ccmd, -1), be_const_var(11) },
