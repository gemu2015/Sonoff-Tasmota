...
static be_define_const_map_slots(be_class_tasmota_map) {
    { be_const_key(_drivers, 99), be_const_var(0) },
    { be_const_key(gc, -1), be_const_closure(Tasmota_gc_closure) },
    { be_const_key(_find_op, 72), be_const_func(tasm_find_op) },
    { be_const_key(resp_cmnd_error, 33), be_const_func(l_respCmndError) },
    { be_const_key(scale_uint, 49), be_const_static_func(l_scaleuint) },
    { be_const_key(add_fast_loop, 39), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(sine_int, 76), be_const_static_func(l_sineint) },
    { be_const_key(_timers, -1), be_const_var(1) },
    { be_const_key(eth, -1), be_const_func(l_eth) },
    { be_const_key(time_dump, 29), be_const_func(l_time_dump) },
    { be_const_key(loglevel, -1), be_const_func(l_loglevel) },
    { be_const_key(arch, -1), be_const_func(l_arch) },
    { be_const_key(memory, 6), be_const_func(l_memory) },
    ...
    { be_const_key(event, 42), be_const_closure(Tasmota_event_closure) },
    { be_const_key(_ccmd, 77), be_const_var(3) },
    ...
    { be_const_key(check_not_method, 27), be_const_closure(Tasmota_check_not_method_closure) },
    { be_const_key(resolvecmnd, 46), be_const_func(l_resolveCmnd) },
    { be_const_key(add_cron, -1), be_const_closure(Tasmota_add_cron_closure) },
    { be_const_key(hostname, -1), be_const_func(l_hostname) },
    { be_const_key(_crons, 28), be_const_var(4) },
    { be_const_key(_settings_def, 64), be_const_comptr(&be_tasmota_settings_struct) },
    { be_const_key(init, 88), be_const_closure(Tasmota_init_closure) },
    { be_const_key(get_power, -1), be_const_func(l_getpower) },
    { be_const_key(_settings_ptr, 61), be_const_comptr(&Settings) },
    { be_const_key(find_key_i, 78), be_const_closure(Tasmota_find_key_i_closure) },
    { be_const_key(_rules, 92), be_const_var(5) },
    { be_const_key(get_option, -1), be_const_func(l_getoption) },
    { be_const_key(rtc, -1), be_const_func(l_rtc) },
    { be_const_key(remove_driver, 44), be_const_closure(Tasmota_remove_driver_closure) },
    { be_const_key(save, 1), be_const_func(l_save) },
    { be_const_key(get_switch, 59), be_const_func(l_getswitch) },
    { be_const_key(wifi, 47), be_const_func(l_wifi) },
    { be_const_key(add_cmd, 57), be_const_closure(Tasmota_add_cmd_closure) },
    { be_const_key(remove_timer, -1), be_const_closure(Tasmota_remove_timer_closure) },
    { be_const_key(remove_cron, 56), be_const_closure(Tasmota_remove_cron_closure) },
    { be_const_key(Rule_Matcher, -1), be_const_class(be_class_Rule_Matcher) },
    { be_const_key(i2c_enabled, 7), be_const_func(l_i2cenabled) },
    { be_const_key(resp_cmnd, -1), be_const_func(l_respCmnd) },
    { be_const_key(find_list_i, 74), be_const_closure(Tasmota_find_list_i_closure) },
    { be_const_key(cmd, -1), be_const_closure(Tasmota_cmd_closure) },
    { be_const_key(load, 79), be_const_closure(Tasmota_load_closure) },
    { be_const_key(get_free_heap, 8), be_const_func(l_getFreeHeap) },
    ...
    { be_const_key(hs2rgb, 52), be_const_closure(Tasmota_hs2rgb_closure) },
    ...
    { be_const_key(wd, 34), be_const_var(7) },
    { be_const_key(publish_rule, -1), be_const_func(l_publish_rule) },
    { be_const_key(set_power, 16), be_const_func(l_setpower) },
    ...
    { be_const_key(time_str, 80), be_const_closure(Tasmota_time_str_closure) },
    { be_const_key(millis, 75), be_const_func(l_millis) },
    ...
    { be_const_key(strptime, 9), be_const_func(l_strptime) },
    { be_const_key(find_op, 24), be_const_closure(Tasmota_find_op_closure) },
    { be_const_key(gen_cb, -1), be_const_closure(Tasmota_gen_cb_closure) },
    { be_const_key(rtc_utc, 21), be_const_func(l_rtc_utc) },
    { be_const_key(next_cron, 91), be_const_closure(Tasmota_next_cron_closure) },
    ...
    { be_const_key(publish, 66), be_const_func(be_mqtt_publish) },
    { be_const_key(add_driver, 67), be_const_closure(Tasmota_add_driver_closure) },
    { be_const_key(response_append, 69), be_const_func(l_respAppend) },
    { be_const_key(_fl, -1), be_const_var(10) },
    { be_const_key(wire2, -1), be_const_var(11) },
    { be_const_key(cmd_res, 19), be_const_var(12) },
};
