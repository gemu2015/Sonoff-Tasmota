...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(global, -1), be_const_var(0) },
    { be_const_key(web_send, -1), be_const_func(l_webSend) },
    { be_const_key(add_cmd, 53), be_const_closure(Tasmota_add_cmd_closure) },
    ...
    { be_const_key(_cmd, 36), be_const_func(l_cmd) },
    { be_const_key(wire2, 22), be_const_var(1) },
    { be_const_key(_crons, 87), be_const_var(2) },
    { be_const_key(cmd_res, -1), be_const_var(3) },
    ...
    { be_const_key(_debug_present, 33), be_const_var(4) },
    ...
    { be_const_key(time_str, 8), be_const_closure(Tasmota_time_str_closure) },
    { be_const_key(get_option, -1), be_const_func(l_getoption) },
    { be_const_key(add_cron, 49), be_const_closure(Tasmota_add_cron_closure) },
    ...
    { be_const_key(memory, 50), be_const_func(l_memory) },
    ...
    { be_const_key(find_op, 40), be_const_closure(Tasmota_find_op_closure) },
    ...
    { be_const_key(millis, 86), be_const_func(l_millis) },
    ...
    { be_const_key(urlfetch_cmd, 21), be_const_closure(Tasmota_urlfetch_cmd_closure) },
    { be_const_key(delay_microseconds, 25), be_const_func(l_delay_microseconds) },
    { be_const_key(scale_uint, -1), be_const_func(l_scaleuint) },
    { be_const_key(_ccmd, 70), be_const_var(7) },
    ...
    { be_const_key(resp_cmnd, 79), be_const_func(l_respCmnd) },
    { be_const_key(add_rule, 5), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(wire1, 63), be_const_var(8) },
    { be_const_key(read_sensors, 42), be_const_func(l_read_sensors) },
    { be_const_key(strptime, 74), be_const_func(l_strptime) },
    { be_const_key(time_reached, -1), be_const_func(l_timereached) },
    { be_const_key(hs2rgb, 13), be_const_closure(Tasmota_hs2rgb_closure) },
    { be_const_key(add_fast_loop, 26), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(remove_rule, 32), be_const_closure(Tasmota_remove_rule_closure) },
    ...
    { be_const_key(remove_cmd, 76), be_const_closure(Tasmota_remove_cmd_closure) },
    ...
    { be_const_key(load, 35), be_const_closure(Tasmota_load_closure) },
    ...
    { be_const_key(_drivers, -1), be_const_var(12) },
    { be_const_key(resp_cmnd_done, -1), be_const_func(l_respCmndDone) },
    { be_const_key(get_switch, 92), be_const_func(l_getswitch) },
    { be_const_key(_settings_ptr, 12), be_const_comptr(&Settings) },
    { be_const_key(add_driver, -1), be_const_closure(Tasmota_add_driver_closure) },
    { be_const_key(delay, -1), be_const_func(l_delay) },
    { be_const_key(remove_driver, 6), be_const_closure(Tasmota_remove_driver_closure) },
