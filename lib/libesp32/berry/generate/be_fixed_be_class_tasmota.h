...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(gen_cb, 78), be_const_closure(Tasmota_gen_cb_closure) },
    ...
    { be_const_key(next_cron, 21), be_const_closure(Tasmota_next_cron_closure) },
    ...
    { be_const_key(_settings_def, 79), be_const_comptr(&be_tasmota_settings_struct) },
    { be_const_key(cmd_res, 10), be_const_var(2) },
    { be_const_key(remove_driver, 9), be_const_closure(Tasmota_remove_driver_closure) },
    ...
    { be_const_key(load, 87), be_const_closure(Tasmota_load_closure) },
    { be_const_key(wire_scan, 74), be_const_closure(Tasmota_wire_scan_closure) },
    ...
    { be_const_key(run_deferred, 91), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(fast_loop, 28), be_const_closure(Tasmota_fast_loop_closure) },
    { be_const_key(_ccmd, -1), be_const_var(7) },
    { be_const_key(event, 25), be_const_closure(Tasmota_event_closure) },
    ...
    { be_const_key(_global_def, 17), be_const_comptr(&be_tasmota_global_struct) },
    ...
    { be_const_key(init, 8), be_const_closure(Tasmota_init_closure) },
    ...
    { be_const_key(remove_rule, 90), be_const_closure(Tasmota_remove_rule_closure) },
