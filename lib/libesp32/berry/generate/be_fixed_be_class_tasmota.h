...
static be_define_const_map_slots(be_class_tasmota_map) {
    ...
    { be_const_key(_crons, 77), be_const_var(0) },
    { be_const_key(urlfetch_cmd, -1), be_const_closure(Tasmota_urlfetch_cmd_closure) },
    { be_const_key(urlfetch, 71), be_const_closure(Tasmota_urlfetch_closure) },
    { be_const_key(resolvecmnd, 38), be_const_func(l_resolveCmnd) },
    ...
    { be_const_key(gc, 93), be_const_closure(Tasmota_gc_closure) },
    { be_const_key(get_free_heap, 23), be_const_func(l_getFreeHeap) },
    { be_const_key(_settings_ptr, -1), be_const_comptr(&Settings) },
    { be_const_key(gen_cb, 32), be_const_closure(Tasmota_gen_cb_closure) },
    { be_const_key(find_key_i, -1), be_const_closure(Tasmota_find_key_i_closure) },
    { be_const_key(wd, 66), be_const_var(2) },
    ...
    { be_const_key(time_dump, 49), be_const_func(l_time_dump) },
    { be_const_key(delay_microseconds, -1), be_const_func(l_delay_microseconds) },
    { be_const_key(global, 74), be_const_var(3) },
    { be_const_key(loglevel, 85), be_const_func(l_loglevel) },
    ...
    { be_const_key(_settings_def, 34), be_const_comptr(&be_tasmota_settings_struct) },
    ...
    { be_const_key(wire1, 81), be_const_var(4) },
    { be_const_key(locale, 27), be_const_func(l_locale) },
    { be_const_key(get_option, -1), be_const_func(l_getoption) },
    { be_const_key(settings, -1), be_const_var(5) },
    { be_const_key(arch, 19), be_const_func(l_arch) },
    { be_const_key(remove_cron, -1), be_const_closure(Tasmota_remove_cron_closure) },
    { be_const_key(rtc, 69), be_const_func(l_rtc) },
    ...
    { be_const_key(wire2, 65), be_const_var(6) },
    { be_const_key(_debug_present, 45), be_const_var(7) },
    { be_const_key(save, 56), be_const_func(l_save) },
    { be_const_key(load, -1), be_const_closure(Tasmota_load_closure) },
    { be_const_key(cmd_res, 35), be_const_var(8) },
    { be_const_key(add_rule, 80), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(_ccmd, -1), be_const_var(9) },
    ...
    { be_const_key(remove_rule, 22), be_const_closure(Tasmota_remove_rule_closure) },
    { be_const_key(set_power, 12), be_const_func(l_setpower) },
    { be_const_key(_rules, 90), be_const_var(10) },
    ...
    { be_const_key(run_deferred, 76), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(yield, 21), be_const_func(l_yield) },
    { be_const_key(exec_cmd, 10), be_const_closure(Tasmota_exec_cmd_closure) },
    { be_const_key(scale_uint, 78), be_const_static_func(l_scaleuint) },
    { be_const_key(i2c_enabled, 95), be_const_func(l_i2cenabled) },
    { be_const_key(fast_loop, -1), be_const_closure(Tasmota_fast_loop_closure) },
    { be_const_key(wifi, -1), be_const_func(l_wifi) },
    { be_const_key(hs2rgb, 92), be_const_closure(Tasmota_hs2rgb_closure) },
    ...
    { be_const_key(resp_cmnd_str, 89), be_const_func(l_respCmndStr) },
    { be_const_key(_cmd, -1), be_const_func(l_cmd) },
    { be_const_key(remove_timer, 16), be_const_closure(Tasmota_remove_timer_closure) },
    ...
    { be_const_key(log, 42), be_const_func(l_logInfo) },
    ...
    { be_const_key(run_cron, 28), be_const_closure(Tasmota_run_cron_closure) },
    { be_const_key(_fl, -1), be_const_var(12) },
    { be_const_key(_global_def, 24), be_const_comptr(&be_tasmota_global_struct) },
};
