...
static be_define_const_map_slots(be_class_tasmota_map) {
    { be_const_key(gc, 53), be_const_closure(Tasmota_gc_closure) },
    { be_const_key(_find_op, 25), be_const_func(tasm_find_op) },
    ...
    { be_const_key(_rules, 73), be_const_var(0) },
    { be_const_key(wd, -1), be_const_var(1) },
    ...
    { be_const_key(exec_tele, 37), be_const_closure(Tasmota_exec_tele_closure) },
    ...
    { be_const_key(_global_addr, 77), be_const_comptr(&TasmotaGlobal) },
    { be_const_key(urlfetch, 10), be_const_closure(Tasmota_urlfetch_closure) },
    ...
    { be_const_key(add_fast_loop, 61), be_const_closure(Tasmota_add_fast_loop_closure) },
    { be_const_key(response_append, 0), be_const_func(l_respAppend) },
    ...
    { be_const_key(next_cron, 87), be_const_closure(Tasmota_next_cron_closure) },
    ...
    { be_const_key(remove_fast_loop, 66), be_const_closure(Tasmota_remove_fast_loop_closure) },
    ...
    { be_const_key(resolvecmnd, 39), be_const_func(l_resolveCmnd) },
    ...
    { be_const_key(read_sensors, 78), be_const_func(l_read_sensors) },
    { be_const_key(init, -1), be_const_closure(Tasmota_init_closure) },
    { be_const_key(add_rule, 2), be_const_closure(Tasmota_add_rule_closure) },
    { be_const_key(get_power, -1), be_const_func(l_getpower) },
    { be_const_key(_drivers, 67), be_const_var(6) },
    { be_const_key(resp_cmnd, 89), be_const_func(l_respCmnd) },
    { be_const_key(run_cron, -1), be_const_closure(Tasmota_run_cron_closure) },
    { be_const_key(web_send, 86), be_const_func(l_webSend) },
    ...
    { be_const_key(load, 48), be_const_closure(Tasmota_load_closure) },
    { be_const_key(hostname, -1), be_const_func(l_hostname) },
    { be_const_key(resp_cmnd_done, -1), be_const_func(l_respCmndDone) },
    { be_const_key(scale_uint, 79), be_const_func(l_scaleuint) },
    ...
    { be_const_key(resp_cmnd_error, 35), be_const_func(l_respCmndError) },
    { be_const_key(find_op, 34), be_const_closure(Tasmota_find_op_closure) },
    ...
    { be_const_key(_fl, 16), be_const_var(7) },
    { be_const_key(_debug_present, -1), be_const_var(8) },
    { be_const_key(resp_cmnd_str, 60), be_const_func(l_respCmndStr) },
    { be_const_key(settings, -1), be_const_var(9) },
    { be_const_key(run_deferred, 58), be_const_closure(Tasmota_run_deferred_closure) },
    { be_const_key(set_power, -1), be_const_func(l_setpower) },
    { be_const_key(_cmd, 56), be_const_func(l_cmd) },
    ...
    { be_const_key(hs2rgb, 85), be_const_closure(Tasmota_hs2rgb_closure) },
    { be_const_key(time_reached, 90), be_const_func(l_timereached) },
    ...
    { be_const_key(_crons, 46), be_const_var(10) },
    { be_const_key(get_switch, 62), be_const_func(l_getswitch) },
