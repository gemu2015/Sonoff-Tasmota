...
static be_define_const_map_slots(m_liblv_tasmota_map) {
    ...
    { be_const_key_weak(init, 4), be_const_closure(lv_tasmota_init_closure) },
    { be_const_key_weak(font_montserrat, -1), be_const_func(lv0_load_montserrat_font) },
    { be_const_key_weak(splash_remove, 2), be_const_closure(lv_tasmota_splash_remove_closure) },
    ...
    { be_const_key_weak(splash_init, -1), be_const_closure(lv_tasmota_splash_init_closure) },
    { be_const_key_weak(splash, -1), be_const_closure(lv_tasmota_splash_closure) },
