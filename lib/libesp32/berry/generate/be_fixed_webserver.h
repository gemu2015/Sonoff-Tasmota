...
static be_define_const_map_slots(m_libwebserver_map) {
    { be_const_key(redirect, 2), be_const_func(w_webserver_redirect) },
    { be_const_key(html_escape, 8), be_const_func(w_webserver_html_escape) },
    ...
    { be_const_key(arg, 15), be_const_func(w_webserver_arg) },
    { be_const_key(content_stop, -1), be_const_func(w_webserver_content_stop) },
    { be_const_key(has_arg, 10), be_const_func(w_webserver_has_arg) },
    ...
    { be_const_key(check_privileged_access, 0), be_const_func(w_webserver_check_privileged_access) },
