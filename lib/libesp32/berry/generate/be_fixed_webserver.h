...
static be_define_const_map_slots(m_libwebserver_map) {
    ...
    { be_const_key(arg, 16), be_const_func(w_webserver_arg) },
    ...
    { be_const_key(content_send, 5), be_const_func(w_webserver_content_send) },
    { be_const_key(arg_size, -1), be_const_func(w_webserver_argsize) },
    { be_const_key(member, 14), be_const_func(w_webserver_member) },
