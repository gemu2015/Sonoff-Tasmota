...
MODULE_PART void SetBitstreamPointer(BitStreamInfo *bsi, int nBytes, unsigned char *buf)
{
	/* init bitstream */
	bsi->bytePtr = buf;
 ...
 **************************************************************************************/
//static __inline 
MODULE_PART void RefillBitstreamCache(BitStreamInfo *bsi)
{
 ...
 * TODO:        optimize for ARM
 **************************************************************************************/
MODULE_PART unsigned int GetBits(BitStreamInfo *bsi, int nBits)
{
 ...
 **************************************************************************************/
MODULE_PART int CalcBitsUsed(BitStreamInfo *bsi, unsigned char *startBuf, int startOffset)
{
	int bitsUsed;
 ...
 **************************************************************************************/
MODULE_PART int CheckPadBit(MP3DecInfo *mp3DecInfo)
{
	FrameHeader *fh;
 ...
 **************************************************************************************/
MODULE_PART int UnpackFrameHeader(MP3DecInfo *mp3DecInfo, unsigned char *buf)
{
 ...
 **************************************************************************************/
MODULE_PART int UnpackSideInfo(MP3DecInfo *mp3DecInfo, unsigned char *buf)
{
	int gr, ch, bd, nBytes;
