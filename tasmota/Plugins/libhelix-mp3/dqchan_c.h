...
MODULE_PART static int DequantBlock(int *inbuf, int *outbuf, int num, int scale)
{
	int tab4[4];
 ...
 **************************************************************************************/
/* __attribute__ ((section (".data"))) */ 
MODULE_PART int DequantChannel(int *sampleBuf, int *workBuf, int *nonZeroBound, FrameHeader *fh, SideInfoSub *sis, 
