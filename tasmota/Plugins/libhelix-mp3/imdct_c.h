...
MODULE_PART static void AntiAlias(int *x, int nBfly)
{
	int k, a0, b0, c0, c1;
	const int *c;
 ...
 **************************************************************************************/
/*__attribute__ ((section (".data"))) */ 
MODULE_PART static void WinPrevious(int *xPrev, int *xPrevWin, int btPrev)
{
 ...
 **************************************************************************************/
/*__attribute__ ((section (".data")))*/ 
MODULE_PART static int FreqInvertRescale(int *y, int *xPrev, int blockIdx, int es)
{
	int i, d, mOut;
...
/*__attribute__ ((section (".data")))*/ 
MODULE_PART static int IMDCT36(int *xCurr, int *xPrev, int *y, int btCurr, int btPrev, int blockIdx, int gb)
{
 ...
 **************************************************************************************/
 // barely faster in RAM
/*__attribute__ ((section (".data")))*/ 
MODULE_PART static int IMDCT12x3(int *xCurr, int *xPrev, int *y, int btPrev, int blockIdx, int gb)
{
 ...
 **************************************************************************************/
/* __attribute__ ((section (".data"))) */ 
MODULE_PART static int HybridTransform(int *xCurr, int *xPrev, int y[BLOCK_SIZE][NBANDS], SideInfoSub *sis, BlockCount *bc)
{
 ...
 **************************************************************************************/
 // a bit faster in RAM
/*__attribute__ ((section (".data")))*/ 
MODULE_PART int IMDCT(MP3DecInfo *mp3DecInfo, int gr, int ch)
{
