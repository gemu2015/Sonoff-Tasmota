...
#define New_WiFiClient() (void*)jtmod_wifi(0,0,0,0)
#define client_connect(A,B,C) (int32_t)jtmod_wifi(1,(uint32_t)A,(uint32_t)B,C)
#define client_connected(A) (int32_t)jtmod_wifi(2,(uint32_t)A,0,0)
#define client_available(A) (int32_t)jtmod_wifi(3,(uint32_t)A,0,0)
#define client_read(A) (uint8_t)jtmod_wifi(4,(uint32_t)A,0,0)
#define client_readn(A,B,C) (int32_t)jtmod_wifi(5,(uint32_t)A,(uint32_t)B,C)
#define client_stop(A) jtmod_wifi(6,(uint32_t)A,0,0)
#define client_delete(A) jtmod_wifi(7,(uint32_t)A,0,0)

#define New_WiFiClientSecure() (void*)jtmod_wifi(10,0,0,0)
#define sclient_connect(A,B,C) (int32_t)jtmod_wifi(11,(uint32_t)A,(uint32_t)B,C)
#define sclient_connected(A) (int32_t)jtmod_wifi(12,(uint32_t)A,0,0)
#define sclient_available(A) (int32_t)jtmod_wifi(13,(uint32_t)A,0,0)
#define sclient_read(A) (uint8_t)jtmod_wifi(14,(uint32_t)A,0,0)
#define sclient_readn(A,B,C) (int32_t)jtmod_wifi(15,(uint32_t)A,(uint32_t)B,C)
#define sclient_stop(A) jtmod_wifi(16,(uint32_t)A,0,0)
#define sclient_setInsecure(A) jtmod_wifi(18,(uint32_t)A,0,0)
#define sclient_setTimeout(A,B) jtmod_wifi(19,(uint32_t)A,B,0)


#define New_HTTP() (void*)jtmod_wifi(30,0,0,0)
#define http_end(A) jtmod_wifi(31,(uint32)A,0,0)
#define http_delete(A) jtmod_wifi(32,(uint32)A,0,0)
#define http_begin(A,B,C) jtmod_wifi(33,(uint32)A,(uint32)B,(uint32_t)C)
...
#define http_addHeader(A,B,C) jtmod_wifi(39,(uint32)A,(uint32)B,(uint32)C)
#define http_collectHeaders(A,B,C) jtmod_wifi(40,(uint32)A,(uint32)B,(uint32)C)
#define http_header(A,B)(char*)jtmod_wifi(41,(uint32)A,(uint32)B,0)
#define http_hasHeader(A,B) jtmod_wifi(42,(uint32)A,(uint32)B,0)
#define http_setFollowRedirects(A,B) jtmod_wifi(43,(uint32)A,(uint32)B,0)
