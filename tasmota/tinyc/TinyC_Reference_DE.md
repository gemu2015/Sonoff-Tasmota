...
| `int fileDownload("datei", char url[])` | URL-Inhalt in Datei herunterladen. Gibt HTTP-Statuscode zurueck (200=ok), -4 wenn 5 min lang kein Byte kam (Datei dann unvollstaendig). Kompatibel mit Scripters `frw()` |
