...
export const Syscall = {
    ...
    // FTP client (V32): a file / a buffer to an FTP server, mode 0=STOR 1=APPE
    FTP_PUT:               556, // (host,user,pw,remote,local,mode) -> int bytes or <0
    FTP_PUT_STR:           557, // (host,user,pw,remote,data,mode)  -> int bytes or <0
