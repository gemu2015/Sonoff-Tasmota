...
export const SYSCALL_ABI = 2;   // V2: + SYS_BLIB_CALL_F (371, fcall float blib call). NB this is a pure append (old bytecode unaffected); the bump is the conservative choice so the IDE flags an fcall .tcb built against pre-fcall firmware.
