...
export const SYSCALL_ABI = 3;   // V3: + SYS_TOUCH_GET (492, touchGet(sel) -> Touch_Status). Pure append (old bytecode unaffected); bumped (conservative) so the IDE flags a touchGet .tcb built against pre-touch firmware. V2: + SYS_BLIB_CALL_F (371, fcall float blib call).
